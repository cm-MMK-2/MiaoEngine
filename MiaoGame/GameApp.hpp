...
#pragma region Shader & Resources
		...
		game->renderer.CreateText(msyh, L"²âÊÔghfp", Rect(0, 0, 200, 30), 12, glm::vec3(0.5f, 0.8f, 0.2f), &textShader);
		game->renderer.CreateText(msyh, L"test²âÊÔ", Rect(200, 0, 200, 30), 12, glm::vec3(0.5f, 0.8f, 0.2f), &textShader);
		game->renderer.CreateText(msyh, L"·±ów×ÖœyÔ‡", Rect(400, 0, 200, 30), 12, glm::vec3(0.5f, 0.8f, 0.2f), &textShader);
		game->renderer.CreateText(msyh, L"ÈÕ±¾ÕZ¥Æ¥¹¥È", Rect(600, 0, 200, 30), 12, glm::vec3(0.5f, 0.8f, 0.2f), &textShader);
		game->renderer.CreateText(msyh, L"Spine And Input Test: ¡û:Run(Left) ¡ú:Run(Right) ¡ü:Jump ¡ý:Lie Down", Rect(20, 380, 600, 30), 12, glm::vec3(0.5f, 0.8f, 0.2f), &textShader);
